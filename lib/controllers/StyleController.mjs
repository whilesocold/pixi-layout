...
import { OVERFLOW, BACKGROUND_SIZE, VERTICAL_ALIGN } from '../utils/constants.mjs';
import { stylesToPixiTextStyles } from '../utils/helpers.mjs';
...
class StyleController {
  ...
  set(styles) {
    ...
    if (this.styles.background instanceof NineSliceSprite || this.styles.background instanceof TilingSprite) {
...
//# sourceMappingURL=StyleController.mjs.map
