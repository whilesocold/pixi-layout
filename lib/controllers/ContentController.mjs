import { Text, Sprite, Graphics, Container } from 'pixi.js';
...
class ContentController {
  ...
  getContentType(content) {
    ...
    if (content.isPixiLayout)
      return "layout";
    if (content instanceof Sprite || content instanceof Graphics || content instanceof Container) {
      if (content.isPixiLayout)
        return "layout";
      return "container";
    }
...
//# sourceMappingURL=ContentController.mjs.map
